...
var
  dates,gr:string;
  sem,IDstudent,IdQue,IdAnket,Number:integer;
begin
...
var
  ...
  while not SqlQuery1.EOF do
    ...
    Pc1.ActivePageIndex := strtoint(tt.caption) ;
    panel1.Caption:=inttostr(pc1.ActivePage.TabIndex);
    sm := (max div 3);

    pc1.ActivePage.Width := nya.Width + 300;
    MyResize(pc1.ActivePage.Width);
    ANketa.Width := pc1.ActivePage.Width+300 ;
    form1.Width := pc1.ActivePage.Width ;
